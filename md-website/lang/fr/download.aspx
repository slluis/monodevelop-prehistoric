...
<ccms:PageHeader runat="server"/>
			...
			<p>
				Deux possibilit&eacute;s de t&eacute;l&eacute;chargement et d段nstallation vous sont offertes. Si 
				vous d&eacute;sirez essayer le dernier release, vous pouvez t&eacute;l&eacute;charger ce <a href="#package">
					paquetage</a>. D誕utre part, si vous souhaitez collaborer &agrave; MonoDevelop, 
				vous pouvez utiliser la version <a href="#svn">Subversion</a>.
			</p>
			<p>
				Quelle que soit la m&eacute;thode d段nstallation choisie, il existe certains 
			...
			<p>Si vous souhaitez des instructions pas &agrave; pas concernant la construction d置n 
			...
			<ol>
				...
				<li>
					Actuellement, <tt>make install</tt> est support&eacute;, mais peut ne pas aboutir. <tt>make 
						run</tt> &agrave; l段nt&eacute;rieur du r&eacute;pertoire MonoDevelop est pour l段nstant la 
